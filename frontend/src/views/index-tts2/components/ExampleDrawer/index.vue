 ...
 * @LastEditTime: 2025-10-22 15:46:11
...
<template>
	<el-drawer class="example-drawer" v-model="show" direction="ltr" :size="1200">
		...
		<div class="example-drawer-content">
			<table class="example-drawer-table">
				<colgroup>
					<col class="col-1" />
					<col class="col-2" />
					<col class="col-3" />
	...
	<el-dialog v-model="openDialog" title="详细配置" width="900" align-center>
		<el-descriptions :column="2" border>
			<el-descriptions-item label="参考音频">
				{{ viewData?.referenceAudioPath }}
			</el-descriptions-item>
			<el-descriptions-item label="生成内容"> {{ viewData?.text }} </el-descriptions-item>
			<el-descriptions-item label="文本分段最大Token">
				{{ viewData?.maxTokensPerSegment }}
			</el-descriptions-item>
			<el-descriptions-item label="情感控制方式">
				{{ getEmotionControlStrategyName(viewData?.emotionControlStrategy) }}
			</el-descriptions-item>
			<el-descriptions-item label="情感参考音频">
